                    ...
                    <div class="panel panel-primary"> 
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                               ...
                               <tr><td><h4><?php echo $summarys->id;?></h4></td><td><h4><?php echo $summarys->company;?></a></h4></td><td><h4><?php echo$summarys->summary;?></h4></td>
                                     <td width="140">
                                         <div class="btn-group">
                                            <a class="btn btn-success" href="edit.php?id=<?php echo $summarys->id;?>">Edit</a>
                                            <a class="btn btn-danger" href="delete.php?id=<?php echo $summarys->id;?>">Delete</a>
                                         </div>
                                     </td>
                               </tr>
                            </table>
