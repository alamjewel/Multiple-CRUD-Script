            ...
            <center>
                    <div id="loginbox" style="margin-top:20px;" class="mainbox col-md-8 col-md-offset-0 col-sm-8 col-sm-offset-2">
                        <div class="panel panel-primary">
                            <div class="panel-heading"><h1>Edit Email Entry</h1>
                                <ul class="pager">
                                ...
                                <form role="form" action="update.php" method="post" autocomplete="off">
                                    <div class="form-group">
                                        <div class="input-group">
                                                ...
                                                <input type="hidden" name="id" class="form-control" id="name" value="<?php echo $emails->id;?>">
                                        </div>
                                    </div>   
                                    <div class="form-group">
                                    <div class="form-group">
                                        <div class="input-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name" value="<?php echo $emails->name;?>" placeholder="Enter  Name" required >
                                        </div>
                                    </div>   
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">Author Name</span>
                                            <input type="email" name="email" class="form-control" value="<?php echo $emails->email;?>" required >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
