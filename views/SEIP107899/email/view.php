                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                               <tr class="success"><th width="50">Serial</th><th>Person Name</th><th>Email Address</th><th>Action</th></tr>
                                 <tr><td><h4><?php echo $emails->id;?></h4></td><td><h4><?php echo $emails->name;?></a></h4></td><td><h4><?php echo $emails->email;?></h4></td>
                                       <td width="140">
                                            <form role="form" method="POST" action="delete.php">
                                                <a class="btn btn-success" href="edit.php?id=<?php echo $emails->id;?>">Edit</a>
                                                <input type="hidden" name="id" value= "<?php echo $emails->id;?>" class="form-control" id="name" value="">
