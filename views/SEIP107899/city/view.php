                    ...
                    <div class="panel panel-primary"> 
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                                 <tr class="success"><th width="50"><h4>ID</h4></th><th><h4>Name</h4></th><th></h4>City</h4></th><th><h4>Action</h4></th></tr>
                                 
                                 <tr><td><h4><?php echo $citys->id ;?></h4></td><td><h4><?php echo $citys->name;?></h4></td><td><h4><?php echo $citys->city;?></h4></td>
                                       <td width="150">
                                            <form role="form" method="POST" action="delete.php">
                                                <a class="btn btn-success" href="edit.php?id=<?php echo $citys->id;?>">Edit</a>
                                                <input type="hidden" name="id" value= "<?php echo $citys->id;?>" class="form-control" id="name" value="">
