            ...
            <center>
                    <div id="loginbox" style="margin-top:20px;" class="mainbox col-md-8 col-md-offset-0 col-sm-8 col-sm-offset-2">
                        <div class="panel panel-primary">
                            <div class="panel-heading"><h1>Edit book Entry</h1>
                                <ul class="pager">
                                ...
                                <form role="form" action="update.php" method="post" autocomplete="off">
                                    <div class="form-group">
                                        <div class="input-group">
                                                ...
                                                <input type="hidden" name="id" class="form-control" id="name" value="<?php echo $books->id;?>">
                                        </div>
                                    </div>   
                                    <div class="form-group">
                                    <div class="form-group">
                                        <div class="input-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="name" value="<?php echo $books->title;?>" placeholder="Enter  Name" required >
                                        </div>
                                    </div>   
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">Author Name</span>
                                            <input type="text" name="author" class="form-control" value="<?php echo $books->author;?>" required >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
