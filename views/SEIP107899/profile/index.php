                    ...
                    <div class="panel panel-primary"> 
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered">
                               ...
                               <?php $serialno=0; foreach($profiles as $profile): $serialno++; ?>
                               <tr><td><?php echo $serialno;?></td>
                                   <td><h4><a title="Click Me to view Data!" data-toggle="tooltip" href="view.php?id=<?php echo $profile['id'];?>"><?php echo $profile['name'];?></a></h4></td>
                                   <td width="100">
                                       <img class='img-rounded' alt='Cinque Terre' width='80' height='50' src="../upload/img/<?php echo $profile['image']; ?>">
                                   </td>
                                   <td width="140">
                                       <div class="btn-group">
                                           <a class="btn btn-success" href="edit.php?id=<?php echo $profile['id'];?>">Edit</a>
                                           <a class="btn btn-danger" href="delete.php?image=<?php echo $profile['image'];?>">Delete</a>
                                       </div>
                                   </td>
                              </tr>
                              <?php endforeach; ?>
